...
- Vercel Git integration, project settings, and protected deployment values are configured. Initial GitHub-hosted external smoke monitoring is implemented; provider-log review, independent second-network monitoring, and custom DNS remain unaccepted.
