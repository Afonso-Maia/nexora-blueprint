...
Deployment `dpl_2VdSf8FiuxenUYMkW1PwP85ekAUD`, correlated with commit `c80e72d258b12bb3c277fba026711b4c0b07dff4`, reached READY and received the temporary aliases. Canonical smoke checks passed routes, static search, headers, indexing isolation, and 404 behavior. Hosted browser evidence passed identifier, status/source context, Portuguese-term, empty-result, focus return, fresh-console, and 390 CSS-pixel reflow checks. The unsafe evaluation directives are absent. Explicit unavailable-index fault injection remains pending, so this accepts the search successor but not the complete resilience or production-release gates.
